...
I encrypted the alphabet on the remote server, copying the result of `grep "" *` into the file krypton6chosenCiphertext so it could be read via the F# script. The password for Krypton7 is ``.

{ for i in {1..30}; do echo -n A; done } > cA
{ for i in {1..30}; do echo -n B; done } > cB
{ for i in {1..30}; do echo -n C; done } > cC
{ for i in {1..30}; do echo -n D; done } > cD
{ for i in {1..30}; do echo -n E; done } > cE
{ for i in {1..30}; do echo -n F; done } > cF
{ for i in {1..30}; do echo -n G; done } > cG
{ for i in {1..30}; do echo -n H; done } > cH
{ for i in {1..30}; do echo -n I; done } > cI
{ for i in {1..30}; do echo -n J; done } > cJ
{ for i in {1..30}; do echo -n K; done } > cK
{ for i in {1..30}; do echo -n L; done } > cL
{ for i in {1..30}; do echo -n M; done } > cM
{ for i in {1..30}; do echo -n N; done } > cN
{ for i in {1..30}; do echo -n O; done } > cO
{ for i in {1..30}; do echo -n P; done } > cP
{ for i in {1..30}; do echo -n Q; done } > cQ
{ for i in {1..30}; do echo -n R; done } > cR
{ for i in {1..30}; do echo -n S; done } > cS
{ for i in {1..30}; do echo -n T; done } > cT
{ for i in {1..30}; do echo -n U; done } > cU
{ for i in {1..30}; do echo -n V; done } > cV
{ for i in {1..30}; do echo -n W; done } > cW
{ for i in {1..30}; do echo -n X; done } > cX
{ for i in {1..30}; do echo -n Y; done } > cY
{ for i in {1..30}; do echo -n Z; done } > cZ
/krypton/krypton6/encrypt6 cA A
/krypton/krypton6/encrypt6 cB B
/krypton/krypton6/encrypt6 cC C
/krypton/krypton6/encrypt6 cD D
/krypton/krypton6/encrypt6 cE E
/krypton/krypton6/encrypt6 cF F
/krypton/krypton6/encrypt6 cG G
/krypton/krypton6/encrypt6 cH H
/krypton/krypton6/encrypt6 cI I
/krypton/krypton6/encrypt6 cJ J
/krypton/krypton6/encrypt6 cK K
/krypton/krypton6/encrypt6 cL L
/krypton/krypton6/encrypt6 cM M
/krypton/krypton6/encrypt6 cN N
/krypton/krypton6/encrypt6 cO O
/krypton/krypton6/encrypt6 cP P
/krypton/krypton6/encrypt6 cQ Q
/krypton/krypton6/encrypt6 cR R
/krypton/krypton6/encrypt6 cS S
/krypton/krypton6/encrypt6 cT T
/krypton/krypton6/encrypt6 cU U
/krypton/krypton6/encrypt6 cV V
/krypton/krypton6/encrypt6 cW W
/krypton/krypton6/encrypt6 cX X
/krypton/krypton6/encrypt6 cY Y
/krypton/krypton6/encrypt6 cZ Z